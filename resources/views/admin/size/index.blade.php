						  ...
						  <tbody>
							...
							<tr>
								...
								<div class="span2">
									...
									@if($category->status==1)
										<a class="btn btn-success" href="{{url('/size-status'.$category->id)}}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
									
									@else
									 <a class="btn btn-danger" href="{{url('/size-status'.$category->id)}}">
								...
								<div class="span2">
									<a class="btn btn-info" href="{{url('/size/edit'.$category->id)}}">
										<i class="halflings-icon white edit"></i>  
									</a>
								</div>
								<div class="span2">
									<form method="post" action="{{url('/size/delete'.$category->id)}}">
									@csrf
									@method('PUT') 
